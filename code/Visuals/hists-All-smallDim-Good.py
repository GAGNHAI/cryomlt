...
year = 'Jakobshavn 2012:'
test = "AllJak12"
fname = '/media/martin/FastData/Data/hdf/predictions/Models-nn-mod/HSmallRun_NN_L1_Adamax_50000_ScaleY/{}/{}_Filtered.h5'.format(area,test)
data = pd.read_hdf(fname,key="data")
plotHist(data['Predicted'],data['Elev_Swath'],'(Filtered)', '/media/martin/FastData/Plots/',year)

year = 'Jakobshavn 2011:'
test = "AllJak11"
fname = '/media/martin/FastData/Data/hdf/predictions/Models-nn-mod/HSmallRun_NN_L1_Adamax_50000_ScaleY/{}/{}_Filtered.h5'.format(area,test)
data = pd.read_hdf(fname,key="data")
plotHist(data['Predicted'],data['Elev_Swath'],'(Filtered)', '/media/martin/FastData/Plots/',year)

year = 'South East 2011:'
test = "AllSe11"
fname = '/media/martin/FastData/Data/hdf/predictions/Models-nn-mod/HSmallRun_NN_L1_Adamax_50000_ScaleY/{}/{}_Filtered.h5'.format(area,test)
data = pd.read_hdf(fname,key="data")
plotHist(data['Predicted'],data['Elev_Swath'],'(Filtered)', '/media/martin/FastData/Plots/',year)
