...
def plotHist(predicted,swath_elev,name,savePath,year):
    ...
    ax.hist(diffs,bins=101,range=[-600,1000], figure=fig)
    ...
    title = '{} Small Dimension Model {}'.format(year,name)
    plt.title(title, figure=fig)
    fig.savefig(savePath+title+'-bad.png',format='png')
...
fname = '/media/martin/FastData/Data/hdf/predictions/Models-nn-compare/CompRun_NN_L1_Adamax_50000_ScaleY/{}/{}_Filtered.h5'.format(area,test)
