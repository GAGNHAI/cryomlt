...
def plotHist(predicted,swath_elev,name,savePath,year):
    ...
    ax.hist(diffs,bins=101,range=[m-std*2,m+std*2], figure=fig)
...
fname = '/media/martin/FastData/Data/hdf/predictions/Models-nn-compare/CompRun_NN_Huber_Adamax_50000_NoScaleY/{}/{}_Filtered.h5'.format(area,test)
