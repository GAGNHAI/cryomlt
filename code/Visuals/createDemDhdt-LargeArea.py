...
plotAndSave(dataA,fullOrFiltered,'Predicted','/media/martin/FastData/Plots/',labelPlot,xTrainA,yTrainA,[],[],plt.cm.jet,mask=mask,vmin=0,vmax=1900,saveDataFile=saveDataFile)
plotAndSave(dataA,fullOrFiltered,'Elev_Swath','/media/martin/FastData/Plots/',labelPlot,xTrainA,yTrainA,[],[],plt.cm.jet,mask=mask,vmin=0,vmax=1900,saveDataFile=saveDataFile)
...
plotAndSave(dataB,fullOrFiltered,'Predicted','/media/martin/FastData/Plots/',labelPlot,xTrainB,yTrainB,[],[],plt.cm.jet,mask=mask,vmin=0,vmax=1900,saveDataFile=saveDataFile)
plotAndSave(dataB,fullOrFiltered,'Elev_Swath','/media/martin/FastData/Plots/',labelPlot,xTrainB,yTrainB,[],[],plt.cm.jet,mask=mask,vmin=0,vmax=1900,saveDataFile=saveDataFile)
