...
plotAndSave(dataA,fullOrFiltered,'Predicted',plotSaveFolder,labelPlot,xTrainA,yTrainA,[],[],plt.cm.Greens,mask=mask,vmin=0,vmax=572,saveDataFile=saveDataFile)

#Create plots - Year B
labelPlot = label + '-' + str(yearB)
plotAndSave(dataB,fullOrFiltered,'Predicted',plotSaveFolder,labelPlot,xTrainB,yTrainB,[],[],plt.cm.Greens,mask=mask,vmin=0,vmax=572,saveDataFile=saveDataFile)
